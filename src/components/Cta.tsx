...
export default function Cta() {
  return (
    <section className="py-20 sm:py-28">
      <Container>
        <div className="relative overflow-hidden rounded-3xl border border-border bg-[radial-gradient(120%_120%_at_50%_0%,var(--color-primary-tint)_0%,var(--color-surface)_65%)] px-6 py-16 text-center sm:px-12">
          <div
            aria-hidden
