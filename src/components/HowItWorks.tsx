...
const STEPS = [
  ...
  },
  {
    ...
    body:
      'Tap check in once you are at the masjid. Your location confirms it — you never have to explain yourself.',
  },
  {
    n: '03',
  ...
  },
  {
    ...
    body:
      'If you noticed something worth knowing — parking, a wudhu area, a photo — share it for whoever comes next.',
  },
]
  ...
  return (
    <section id="how" className="scroll-mt-24 py-20 sm:py-28">
      <Container>
        ...
        <p className="mx-auto mt-10 max-w-2xl text-center text-sm text-subtle-foreground">
